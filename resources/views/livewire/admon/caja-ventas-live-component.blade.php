<div>
    <div class="conteiner-fluid">
        <h1>Venta, devolución, y envases de productos</h1>
        ...
        <div class="row sticky-top" style="background-color: white; padding:1.5rem;">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6">
                ...
                Total= $ <span id="GranGranTotal"></span>
            </div>
        </div>
        ...
        @if($this->idusr > '0')
            <div class="row">
                <div style="background-color: rgb(184, 219, 249); padding:1.5rem; margin:1rem; font-size:120%; cursor:pointer;" onclick="VerNoVer('devolver','pedidos')">
                    <i class='fas fa-hand-holding-usd'></i> Devolver Pedidos @if($usr) de {{$usr->nombre}} @endif
                    $ <span id="totaldevuelve"> </span>
                </div>
            </div>

            <div class="row" id="sale_devolverpedidos" style="display:block;">
                @if(count($pedidos) > 0)
        ...
        <div>
            <div class="row">
                <div style="background-color: rgb(184, 219, 249); padding:1.5rem; margin:1rem; font-size:120%; cursor:pointer;" onclick="VerNoVer('devolver','envases')">
                    <i class='fas fa-wine-bottle'></i> Devolver Envases @if($usr) de {{$usr->nombre}} @endif
                    $ <span id="totalfrascos"> </span>
                </div>
            </div>

            <div class="row" id="sale_devolverenvases" style="display:block;">
        ...
        <!--######################################################################################################################-->
        <div class="row">
            <div style="background-color: rgb(184, 219, 249); padding:1.5rem; margin:1rem; font-size:120%; cursor:pointer;" onclick="VerNoVer('ventaBAC','productos')">
        ...
        <div class="row" id="sale_ventaproductos" style="display:block;">
            @foreach($productos as $prod)
                ...
                @foreach(explode(',', $prod->variantes)  as $sabor)
                    <div class="col-lg-3 col-md-4 col-sm-12" style="margin:1rem; min-height:70px;">
