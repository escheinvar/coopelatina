<div>
    <h1>Caja</h1>
        ...
        <!--######################################################################################################################-->
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12" style="background-color: rgb(159, 210, 255); padding:1rem;">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12" style="background-color: rgb(159, 210, 255);padding:1rem;">
                ...
                @if($monto != 0)
                    <button type="button" class="btn btn-success" wire:click="cajaRegistra()">Registrar</button>
                @endif
            </div>
        </div>  
